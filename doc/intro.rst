...
The `Drupal Extension to Behat and Mink <https://drupal.org/project/drupalextension>`_ provides Drupal-specific functionality for the `Behavior-Driven Development <http://dannorth.net/introducing-bdd/>`_ testing frameworks of `Behat and Mink <http://extensions.behat.org/mink/>`_.
