...
class RandomContextSpec extends ObjectBehavior {
  ...
  public function let(DrupalDriverManager $drupal, DrupalDriver $driver, CoreInterface $core, Random $random) {
  ...
  public function it_converts_placeholders_to_random_strings(ScenarioScope $scope, ScenarioInterface $scenario, FeatureNode $feature, StepNode $step1, StepNode $step2) {
