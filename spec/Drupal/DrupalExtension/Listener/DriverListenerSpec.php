...
/**
 * Tests the DriverListener class.
 */
class DriverListenerSpec extends ObjectBehavior {

  public function let(DrupalDriverManager $drupal, ScenarioTested $event, FeatureNode $feature, ScenarioNode $scenario, Environment $environment) {
    $parameters = [
    ...
    $feature->getTags()->willReturn(['api']);
  ...
  public function it_resets_the_default_drupal_driver_before_scenarios(ScenarioTested $event, DrupalDriverManagerInterface $drupal, Environment $environment, FeatureNode $feature, ScenarioNode $scenario) {
